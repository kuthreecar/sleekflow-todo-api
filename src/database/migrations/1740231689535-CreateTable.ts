...
export class CreateTable1740231689535 implements MigrationInterface {
  name = 'CreateTable1740231689535';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "user-status" ("id" integer NOT NULL, "name" character varying NOT NULL, CONSTRAINT "PK_508a75a8d9b10b0e9d7fe941f16" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "todo-item-status" ("id" integer NOT NULL, "name" character varying NOT NULL, CONSTRAINT "PK_bf976f7713ecbbe8a3a79c88835" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "todo-item" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "statusId" integer, CONSTRAINT "PK_9ddf22b9fd91c66b33d4bc170bf" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "FK_dc18daa696860586ba4667a9d31" FOREIGN KEY ("statusId") REFERENCES "user-status"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE "todo-item"`);
    await queryRunner.query(`DROP TABLE "todo-item-status"`);
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP TABLE "user-status"`);
